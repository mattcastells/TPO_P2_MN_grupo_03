...
public class CategoryController {
    ...
    @DeleteMapping
    public ResponseEntity<CategoryResponseDTO> update(@RequestBody CategoryRequestDTO categoryRequestDTO) {
        return ResponseEntity.ok(categoryService.delete(categoryRequestDTO));
    }
} 